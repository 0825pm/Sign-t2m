...
Usage:
    ...
    python vis_generation.py \
        ...
        --mean_path /home/user/Projects/research/SOKE/data/Phoenix_2014T/mean_120.pt \
        --std_path  /home/user/Projects/research/SOKE/data/Phoenix_2014T/std_120.pt \
        --num_samples 5 --output vis_output/mbart_phoenix
    ...
    python vis_generation.py \
        ...
        --mean_path /home/user/Projects/research/SOKE/data/Phoenix_2014T/mean_120.pt \
        --std_path  /home/user/Projects/research/SOKE/data/Phoenix_2014T/std_120.pt \
        --texts "morgen wird es regnen" "heute ist das wetter gut" \
        --lengths 80 80 --output vis_output/mbart_phoenix
"""
...
def _run_text_mode(model, args, device, mean_np, std_np, output_root):
    ...
    srcs = [args.dataset] * len(texts)

    for i, (text, length) in enumerate(zip(texts, lengths)):
        print(f"\n  [{i+1}/{len(texts)}] \"{text}\" (T={length})")
        with torch.no_grad():
            generated = model.generate([text], [length], srcs=[srcs[i]])
...
def _run_val_mode(model, args, device, mean, std, mean_np, std_np,
    ...
    dataset = SignText2MotionDataset(
        ...
        split=args.split, mean=mean, std=std, csl_mean=csl_mean, csl_std=csl_std,
    ...
    for idx_i, ds_idx in enumerate(indices):
        ...
        # GT 역정규화
        m_np = csl_mean.numpy() if src == 'csl' else mean_np
        s_np = csl_std.numpy()  if src == 'csl' else std_np
...
def main():
    ...
    parser.add_argument('--nfeats', type=int, default=133,
    ...
    parser.add_argument('--mean_path',
        default='/home/user/Projects/research/SOKE/data/How2Sign_528d/mean_528.pt')
    parser.add_argument('--std_path',
        default='/home/user/Projects/research/SOKE/data/How2Sign_528d/std_528.pt')
    parser.add_argument('--csl_mean_path',
        default='/home/user/Projects/research/SOKE/data/CSL-Daily_528d/mean_528.pt')
    parser.add_argument('--csl_std_path',
        default='/home/user/Projects/research/SOKE/data/CSL-Daily_528d/std_528.pt')
